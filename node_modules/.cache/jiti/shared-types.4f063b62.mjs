...
const SUBAGENT_LIFECYCLE_ARTIFACT_VERSION = exports.SUBAGENT_LIFECYCLE_ARTIFACT_VERSION = 1;
...
const DEFAULT_MAX_SUBAGENT_SPAWNS_PER_SESSION = exports.DEFAULT_MAX_SUBAGENT_SPAWNS_PER_SESSION = 40;
const SUBAGENT_ACTIONS = exports.SUBAGENT_ACTIONS = ["list", "get", "models", "create", "update", "delete", "eject", "disable", "enable", "reset", "status", "interrupt", "resume", "steer", "append-step", "doctor", "schedule", "schedule-list", "schedule-status", "schedule-cancel"];
