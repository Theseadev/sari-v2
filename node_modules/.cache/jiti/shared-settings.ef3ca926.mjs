 ...
 */function createParallelDirs(chainDir, stepIndex, taskCount, agentNames) {for (let i = 0; i < taskCount; i++) {const subdir = path.join(chainDir, `parallel-${stepIndex}`, `${i}-${agentNames[i]}`);fs.mkdirSync(subdir, { recursive: true });}} /* v9-82e9b3fad0690f17 */
