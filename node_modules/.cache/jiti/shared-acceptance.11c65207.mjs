"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.acceptanceFailureMessage = acceptanceFailureMessage;exports.aggregateAcceptanceReport = aggregateAcceptanceReport;exports.evaluateAcceptance = evaluateAcceptance;exports.formatAcceptancePrompt = formatAcceptancePrompt;exports.normalizeAcceptanceInput = normalizeAcceptanceInput;exports.parseAcceptanceReport = parseAcceptanceReport;exports.resolveEffectiveAcceptance = resolveEffectiveAcceptance;exports.stripAcceptanceReport = stripAcceptanceReport;exports.validateAcceptanceInput = validateAcceptanceInput;var _nodeChild_process = await jitiImport("node:child_process");
...
function validateAcceptanceInput(input, pathLabel = "acceptance") {
  ...
  if (typeof input === "string") {
    if (!VALID_LEVELS.has(input)) errors.push(`${pathLabel} has invalid level '${input}'.`);
    return errors;
  }
